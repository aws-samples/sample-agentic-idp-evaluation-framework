...
Yes — create a markdown file under `packages/shared/skills/<category>/<id>.md` with the standard frontmatter + support matrix, run `npm run build:skills -w packages/shared`, and rebuild. See [**Capabilities**](/docs/capabilities#adding-a-new-capability).
