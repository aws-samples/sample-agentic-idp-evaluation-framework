...
You can accept the recommendation, add/remove capabilities, or chat with the agent to refine.
...
1. Streams an **architecture recommendation** (text + Mermaid diagram + cost table at 1k/10k/100k docs/month).
...
- [**Pricing**](/docs/pricing) — what these numbers mean at 100k documents/month.
